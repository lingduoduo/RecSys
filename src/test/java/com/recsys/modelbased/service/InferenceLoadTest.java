...
class InferenceLoadTest {
    ...
    void setUp() throws Exception {
        ...
        runtimeProvider = new ModelRuntimeProvider(locator, new com.recsys.modelbased.config.ABTestConfig());
        service = new RecommendationService(
                runtimeProvider,
                new ABTestService(new com.recsys.modelbased.config.ABTestConfig())
        );
    }
